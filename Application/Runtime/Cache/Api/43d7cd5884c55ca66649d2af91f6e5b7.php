                   ...
                   <div class="recipients marT10" style="padding-left: 15px">
                    ...
                    <div class="recipients marT10" style="padding-left: 15px" >
                        ...
                        <div class="aptTable span10 marT10" style="background:#252723;padding:0px;float: left;width: 90%; margin-left: 8px;">
                                ...
                                <div class="wrapper">
                                    <div class="process">
                                        <div class="box" style="width: 30%;min-width: 276px">
                                            <img src="cid:tuimg" alt="图片" class="photo"/>
                                        </div>
                                        <div class="score">
                            ...
                            <div class="mainBlock" id="<?php echo ($attack_vo["id"]); ?>">
                                <div class="line">
                                    <span>
...
//    编辑用户
    ...
    $('#user_edite_form').submit(function(e){
        ...
        $("#fade").hide();
           /* $.ajax({
                url:'/APTSecUI/index.php/Api/User/do_user_edite',
                type:'POST',
                dataType:'json',
                data:editeUser_data,
    ...
    $('#user_delete_form').submit(function(e){
        ...
        $("#fade").hide();
       /* $.ajax({
            url:'/APTSecUI/index.php/Api/User/user_delete',
            type:'POST',
            dataType:'json',
            data:{'id':id},
            success:function(data){
...
///////////////////////------//////////////////////
  jQuery(function ($) {
    ...
    //    send('/APTSecUI/index.php/Api/User/add_web',webdata);
    // });
