            ...
            <div class="col-xs-12">
             ...
             <div class="formArea marT10" >
                ...
                <div class="aptListBtnGroup" >
                    ...
                    <a href="#" class="tbl_delete" id="userDel"><i class="icon-remove  bigger-120 red "></i>批量删除</a>
                </div>
...
<script>
    ...
    $('#addUser_form').submit(function(e){
        ...
        if (checkVal =='') {
            ...
            $.ajax({
                 type: "POST",
                 url: "/APTSecUI/index.php/Home/User/user_add",
                 data: data,
                 dataType: "json",
...
//    单条删除
    function tbl_delete(id) {
        ...
        layer.confirm('您确定要删除这条数据吗？', {
            ...
            $.post("/APTSecUI/index.php/Home/User/user_delete", {'id':id}, function (data) {
                if(data.status=='success'){
...
//批量删除数据
    $(document).on("click",".tbl_delete",function(){
        ...
        layer.confirm('您确定要删除这些数据吗？', {
            ...
            $.post("/APTSecUI/index.php/Home/User/user_delete", {'id':ids}, function (data) {
                if(data.status=='success'){
                    layer.msg(data.msg);
                    window.location.reload();
                    $(":checked").attr('checked',false);
		...
		$(document).on("click",".editeUser",function(){
            ...
            $.ajax({
                type: "POST",
                url: "/APTSecUI/index.php/Home/User/get_usergroup",
                data: {'id':id},
                dataType: "json",
                success: function(data){
    ...
    $('#user_edite_form').submit(function(e){
        ...
        $.ajax({
            url:'/APTSecUI/index.php/Home/User/do_user_edite',
            type:'POST',
            dataType:'json',
            data:editeUser_data,
            success:function(data){
         ...
         function operateFormatter(value, row, index) {
             if(index!==0){
                 return [
                     ...
                     '<a class="red deleteuser"  onclick="tbl_delete('+value+')"  href="javascript:;" data="'+value+'" title="删除"><i class="icon-trash bigger-130"></i></a>'
                 ].join('');
             }else{
...
//           console.log(row.id);
        ...
        $('#reportTable').bootstrapTable({
            method: 'get',
            url: '/APTSecUI/index.php/Home/User/userOk',
            cache: false,
            striped: true,
