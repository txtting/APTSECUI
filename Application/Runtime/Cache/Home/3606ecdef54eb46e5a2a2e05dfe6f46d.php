    ...
    <div class="tabbable">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <h2>最新紧急事件<a href="/APTSecUI/index.php/Urgent/index">更多...</a></h2>
                        ...
                        <h2>资产探测<a href="/APTSecUI/index.php/Vir/assets_detail">更多...</a></h2>
                        <table cellpadding="0" cellspacing="0">
                        ...
                        <div class="aptBox aptBoxW7 aptBoxH250 marL10 marT10 flaotLeft boxShadow"  style="border:0px solid red; min-width:780px;padding-top:0px;">
                               ...
                               <div class="circleCon">
                               <ul id="data5">
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"  title="中危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"   title="高危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"   title="中危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="red" data-rel="tooltip"  title="高危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"  title="中危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"  title="高危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"  title="中危数量30个"></span></a></li>
                               <li ><a href="/APTSecUI/index.php/Urgent/index"><span class="org" data-rel="tooltip"  title="高危数量30个"></span></a></li>
                               ...
                               <ul id="data6">
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="中危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="red" data-rel="tooltip"   title="高危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="中危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="高危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="中危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="高危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"   title="中危数量30个"></span></a></li>
                               <li><a href="/APTSecUI/index.php/safe/index"><span class="org" data-rel="tooltip"  title="高危数量30个"></span></a></li>
                    ...
                    load: function () {
                       ...
                       /* var series = this.series[0];
                        ...
                        setInterval(function () {
                            $.ajax({
                                type:'post',
                                url:'/APTSecUI/index.php/Home/Vir/getlinetu',
                                async: false,
                                dataType:'json',
                                success:function(data){
                                    series.addPoint(data.d2, true, true);
                                    series1.addPoint(data.d3, true, true);
                                }
                            })
                        }, 10000);
...
$(document).ready(function(){
    var get_datas = function(){
        $.ajax({
            url: '/APTSecUI/index.php/Home/Vir/indexdata',
            type: 'POST',
            dataType: 'json',
            async: false,
            success:function(data){
...
//        alert(30)
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Vir/indexlinetu',
        type: 'POST',
        dataType: 'json',
        async: false,
        data: {'sign':v},
...
function jump(v){
    $.ajax({
        url: '/APTSecUI/index.php/Home/Vir/indexdiantu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data: {'sign':v},
...
function get_data5(data){
    ...
    if (data.data5) {
        $.each(data.data5, function(index, value){
            str1 +='<li><a href="/APTSecUI/index.php/Urgent/index"><span class="'+value.class+'" title="'+value.title+'个"></span></a></li>';
        });
    }
...
function get_data6(data){
    ...
    if (data.data6) {
        $.each(data.data6, function(index, value){
            str1 +='<li><a href="/APTSecUI/index.php/safe/index"><span class="'+value.class+'" title="'+value.title+'个"></span></a></li>';
        }); 
    }
    str1 += '<div style="clear:both;"></div>';
    $('#data6').html(str1) ;
...
///////////////////////------//////////////////////
  jQuery(function ($) {
    ...
    //    send('/APTSecUI/index.php/Home/Vir/add_web',webdata);
    // });
