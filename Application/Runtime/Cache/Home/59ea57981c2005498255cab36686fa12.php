            ...
            <div class="col-xs-12">
                <div class="aptTable span10 marT10" style="background:#252723;padding:0px;">
                    ...
                    <div class="wrapper">
                    	<div class="process">
	                    	<div class="box">	
	                    		<img src="/APTSecUI/Public/css/assets/images/score/6.jpg">
	                    	</div>
	                    	<div class="score">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".chooseBtn").click(function () {
            ...
            $.ajax({
                type:"POST",
                url: "/APTSecUI/index.php/Home/Setting/attack_change_nosel",
                data:{'ids':ids},
                dataType:"json",
		...
		$(".resetBtn").click(function () {
            ...
            $.ajax({
                type:"POST",
                url: "/APTSecUI/index.php/Home/Setting/attack_change_sel",
                dataType:"json",
                success:function(data){
                    if(data.status=='success'){
                        layer.msg(data.msg);
