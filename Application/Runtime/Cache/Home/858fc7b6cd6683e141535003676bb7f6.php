...
<div class="main-content">
            ...
            <div class="col-xs-12">
                <div class="table-responsive">
                    <form class="J_ajaxForm"  method="post">
                        <div class="table_full" style="background:#f5f5f5; padding-top:8px; padding-bottom:8px;">
                        ...
                        <div class="form-actions" style="margin-top:5px;">
                            ...
                            <!-- <a class="btn" href="/APTSecUI/index.php/Home/User">返回</a> -->
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            url:'/APTSecUI/index.php/Home/User/authorize_post',
            type:'POST',
            dataType:'json',
            data:addNet_data,
            success:function(data){
                if(data.status=='success'){
                    layer.msg(data.msg);
                    window.location.href="/APTSecUI/index.php/Home/User/usergroup";
