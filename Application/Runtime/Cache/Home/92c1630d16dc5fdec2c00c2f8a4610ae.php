...
//                "vertical-align":"middle",
    ...
    $('#reportTable').bootstrapTable({
        method: 'get',
        url: '/APTSecUI/index.php/Home/Safe/filebiao',
        cache: false,
        //height: 500,
        striped: true,
...
//    设置攻击时间的宽度
    ...
    $("#kSearch1").click(function(){
        ...
        $.ajax({
            url: '/APTSecUI/index.php/Home/Safe/filetu',
            type: 'GET',
            async: false,
            dataType: 'json',
            data: {'da1':da1},
...
$(document).on('click',".jump",function(){
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Safe/filezhutu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data: {'sign':v},
