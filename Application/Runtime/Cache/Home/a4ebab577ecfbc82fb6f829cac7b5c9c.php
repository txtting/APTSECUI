            ...
            <div class="col-xs-12" >
                ...
                <div class="aptBox aptBoxW6 aptBoxH3 marL10 boxShadowjc">
                    ...
                    <div class=" aptBoxW6 " style="position: absolute;right: 1px;bottom: 40px">
                        <a href='javascript:;' class='jump' data='1' style="position: absolute;top: 2px;left: 50px" title="查看上一周期" >
                ...
                <div class="aptTable span10 marT10 tableShow boxShadowjc">
                    <div class="aptListBtnGroup"><h4>恶意流量攻击详情</h4></div>
...
$(document).ready(function(){
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Safe/brutu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data:{'da1':da1},
...
$(document).on('click',".jump",function(){
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Safe/bruzhutu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data: {'sign':v},
...
//                    y:28
        ...
        series:data.data2
        //console.log(data.data2[8].data[8][0]);
    });
}
...
function detailFormatter(index, row) {
    ...
    var rows = {'攻击类型 ':' '+row.byzoroType,'说明 ':' '+row.details,'攻击方式 ':' '+row.attackType,'威胁等级 ':' '+row.severity}
...
$(document).ready(function(){
    ...
    $('#reportTable').bootstrapTable({
            method: 'get',
            url: '/APTSecUI/index.php/Home/Safe/brubiao',
//             search:true,
            cache: false,
//            height: 400,
            striped: true,
            ...
            rowStyle: function (row, index) {
                ...
                }else if(row.severity=="中等"){
                    return {
                        classes: classes[1]
                    }
                }else if(row.severity=="低"){
                    return {
                        classes: classes[0]
                    }
                }
