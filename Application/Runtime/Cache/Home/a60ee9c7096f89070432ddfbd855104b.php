...
<script>
    ...
    $('#ignore_form').submit(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/APTSecUI/index.php/Home/Urgent/user_add",
            data: data,
            dataType: "json",
...
function jump(v){
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Urgent/indexzhutu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data: {'sign':v},
...
$(document).ready(function(){
    ...
    $.ajax({
        url: '/APTSecUI/index.php/Home/Urgent/indextu',
        type: 'GET',
        async: false,
        dataType: 'json',
        data:{'da1':da1},
...
$(document).ready(function(){
    ...
    $('#reportTable').bootstrapTable({
            method: 'get',
            url: '/APTSecUI/index.php/Home/Urgent/indexbiao',
//             search:true,
            cache: false,
//            height: 400,
            striped: true,
...
///////////////////////------//////////////////////
  jQuery(function ($) {
    ...
    //    send('/APTSecUI/index.php/Home/Urgent/add_web',webdata);
    // });
