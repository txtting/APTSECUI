            ...
            <div class="col-xs-12">
                ...
                <div class="chartBox marT10" style="position: relative">
                    ...
                    <div class="aptBox aptBoxW4 aptBoxH3 boxShadowjc" >
                        ...
                        <div id="container" style=" width:97%;height:98%;margin:auto;"></div>
                    </div>
                    ...
                    <div class=" aptBoxW6 " style="position: absolute;right: 1px;bottom: 40px">
                        <a href="#" style="position: absolute;top: 2px;left: 63px" title="查看上一周期" >
                            <i class="icon-caret-left icon-2x"></i>
                        </a>
                        <!--<h4 style="margin:3px 40%;">3-8——3-17</h4>-->
                        <a href="#"  style="position: absolute;top: 2px;right: 8px" title="查看下一周期">
                ...
                <div class="aptTable span10 marT10 tableShow boxShadowjc">
                    <div class="aptListBtnGroup"><h4><b>30</b>天扫描事件分布详情</h4></div>
...
//                    console.log(data);
    ...
    var chart1=function(data){
        $('#container').highcharts({
           /* colors: ['#E03412', '#ea7f0c', '#cbf621', '#7798BF', '#aaeeee', '#ff0066', '#eeaaee',
                '#55BF3B', '#DF5353', '#17D6D3', '#F7B91C','#2E67B9'
            ],*/
//            '#335AA7', '#7DC8DB', '#CBE8FA', '#6DC6F2', '#36B0BB'
           /* colors: ['#335AA7','#438EA0','#6FADB9', '#7DC8DB','#9DC6CE','#B7D6E8', '#CBE8FA',
                '#6DC6F2','#27909B', '#36B0BB'
            ],*/
            colors: ['#335AA7','#438EA0','#5F76B7','#6FADB9','#48B2C6', '#7DC8DB','#9DC6CE','#B7D6E8',
                '#CBE8FA',
                '#6DC6F2','#27909B', '#36B0BB','#8195D6','#8BA2E5','#A7ADCE',
                '#5A6FB2','#89A0E5','#7681A0'
            ],
            chart:{
            ...
            series: [{
                ...
                innerSize:"40%",
                name: '攻击数',
                data: [['后门',30],['鸡肉行为',40],['蠕虫病毒',40],['木马回连',20],['DDoS',22],
                    ['后门',30],['蠕虫病毒',40],['木马回连',20],['DDoS',22],['DDoS',22], ['后门',30],
                    ['蠕虫病毒',40],['木马回连',20],['DDoS',22],['DDoS',22],['木马回连',20],['DDoS',22],['DDoS',22]]
