...
ace.settings={
	...
	main_container_fixed:function(a){
		...
		if(navigator.userAgent.match(/webkit/i)){
			...
			setTimeout(function(){ace.toggleClass(d,"menu-min")},0)
		}
	},
	sidebar_collapsed:function(c){
		...
		if(c){
			...
			ace.removeClass(d,b);ace.addClass(d,a);
...
ace.addClass=function(c,b){
	if(!ace.hasClass(c,b)){
		var a=c.className;c.className=a+(a.length?" ":"")+b
	}
};
